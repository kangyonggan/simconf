package com.kangyonggan.app.simconf.aop;


import com.kangyonggan.app.simconf.annotation.LogTime;
import com.kangyonggan.app.simconf.util.AopUtil;
import com.kangyonggan.app.simconf.util.DateUtils;
...
public class LogAop {
    ...
    @Pointcut("execution(* com.kangyonggan.app.simconf..*.*(..))")
